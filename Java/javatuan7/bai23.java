/*
Bài 23. Thực hiện code tạo 2 lớp Vehicle và Car như sau:
...
Trong lớp Car, chúng ta đã sửa đổi mã của phương thức để in ra "The car starts with a key" thay vì câu thông báo mặc định của lớp cha.
 */
package javatuan7;
