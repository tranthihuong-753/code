...
namespace De1
{
    public partial class Cau4Form : Form
    {
        public Cau4Form()
        {
            InitializeComponent();
        ...
        // Hàm load dữ liệu từ SQL SinThe cho vào datagridview <3>
        ...
        // Hàm khi di chuột thì hiện lên textbox1 <4>
        ...
        // Hàm có tác dụng kiểm tra xem length.textbox=10 -> thực hiện <6> 
        private void search()
        {
        ...
        private void Cau4Form_Load(object sender, EventArgs e)
        {
        ...
        // Khong cho textbox nap ky tu khac int <5> phai de english 
        // nhap khac thi keu beep 
